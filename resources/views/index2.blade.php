...
<!-- Mirrored from fullstacksolution.net/demo/hireahelper/02-homepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Nov 2022 21:16:53 GMT -->
<head>
<meta charset="utf-8">
          ...
          <form class="form-inline book-now-home">
            <div class="form-group">
              <div class="input-group">
                <div class="dropdown category-dropdown text-left"> <a data-toggle="dropdown" href="#"><i class="fa fa-map-o" aria-hidden="true"></i> <span class="change-text">Select City</span> <i class="fa fa-caret-down pull-right" aria-hidden="true"></i> </a>
            ...
            <div class="form-group">
              <div class="input-group">
                <div class="dropdown category-dropdown text-left"> <a data-toggle="dropdown" href="#"><span class="change-text">Select City</span> <i class="fa fa-caret-down pull-right" aria-hidden="true"></i> </a>
                  <ul class="dropdown-menu category-change">
                    <li><a href="#">Fashion&amp;Beauty</a></li>
                    <li><a href="#">Cars &amp; Vehicles</a></li>
                    <li><a href="#">Electronics&amp;Gedgets</a></li>
    ...
    <div class="container text-center services_back">
      <div class="col-md-12">
        ...
        <ul class="services-list">
          <li><a href="service_detail.html"><img src="images/02home/services-icons/cleaning.png" alt="Cleaning" /><br />
            Cleaning</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/electrical.png" alt="Electrical" /><br />
            Electrical</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/plumbing.png" alt="Plumbing" /><br />
            Plumbing</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/appliances.png" alt="Appliances" /><br />
            Appliances</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/carpentry.png" alt="Carpentry" /><br />
            Carpentry</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/geyser.png" alt="Geyser Service" /><br />
            Geyser Service</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/vehicle.png" alt="Vehicle Care" /><br />
            Vehicle Care</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/pest.png" alt="Pest Control" /><br />
            Pest Control</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/painting.png" alt="Painting" /><br />
            Painting</a></li>
          <li><a href="service_detail.html"><img src="images/02home/services-icons/more.png" alt="View More" /><br />
            View More</a></li>
        </ul>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6"> 
          ...
          <div class="counter_box text-center">
            ...
            <div class="counter_number_right">
              <div class="counter_number counter"><span class="stat-count">8</span>+</div>
          ...
          <div class="cmsmasters_quotes cmsmasters_quotes_grid quote_two">
            ...
            <div class="cmsmasters_quotes_list">
              <div class="cmsmasters_quote">
                <article class="cmsmasters_quote_inner">
                  <div class="cmsmasters_quote_img_info_wrap">
                    <div class="cmsmasters_quote_image"><img src="images/02home/clinte3.png" alt="Kevin" /></div>
                    <div class="cmsmasters_quote_info_wrap">
                      <h3 class="cmsmasters_quote_title">Kevin Austin</h3>
                      <h5 class="cmsmasters_quote_subtitle">Lorem Ipsum</h5>
                    </div>
            ...
            <div class="view_all"><a href="#">View All Testimonails <i class="fa fa-angle-right" aria-hidden="true"></i> </a></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <p class="copyright">&copy; Hire A Helper 2017 All Right Reserved</p>
          </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from fullstacksolution.net/demo/hireahelper/02-homepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Nov 2022 21:17:19 GMT -->
</html>